...
fa2 = load(
    ...
    sources=["build.cpp", "flash_attention_2.cu"],
...
def compare(func, *args, name="Funktion"):
...
manual_result, manual_attention_time = compare(
    manual_attention, q, k, v, name="Manual attention from PyTorch"
)


print(f"\nbenchmarking custom cuda attention...")
custom_result, custom_attention_time = compare(
    fa2.flash_attention_fwd, q, k, v, name="Custom Attntion"
)
