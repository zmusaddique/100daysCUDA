...
__global__ void stencil_tiled(float *in, float *out, unsigned int N) {
...
__global__ void stencil_kernel_coarsed(float *in, float *out, unsigned int N) {
...
__global__ void stencil_coarsed_with_reg_tiling(float *in, float *out,
                                                unsigned int N) {
  int iStart = blockIdx.z * OUT_TILE_DIM;
  int j = blockIdx.y * blockDim.y + threadIdx.y;
  int k = blockIdx.x * blockDim.x + threadIdx.x;
